  ...
  return (
    <motion.div
      ...
      className={clsx(
        ...
        "scroll-ml-[var(--scroll-padding)] flex-col justify-end",
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 rounded-3xl bg-gradient-to-t from-black from-[calc(7/16*100%)] ring-1 ring-inset ring-gray-950/10 sm:from-[calc(5/16*100%)]"
      />
    ...
    <div className="overflow-hidden py-32">
      ...
      <div
        ...
        className={clsx(
          ...
          "[--scroll-padding:max(theme(spacing.6),calc((100vw-var(--container-2xl))/2))]",
          "lg:[--scroll-padding:max(theme(spacing.8),calc((100vw-var(--container-2xl))/2))]"
        )}
      >
        ...
        <div className="w-[36rem] shrink-0 sm:w-[54rem]" />
      </div>
